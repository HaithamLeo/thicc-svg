# thicc-svg — Web Editor

Visual editor for designing 3D objects from SVGs, text, and pixel art. This is the app behind [thicc-svg.design](https://thicc-svg.design).
...
The web editor imports the engine as a workspace dependency (`"thicc-svg": "file:../engine"`), so changes to the engine require a rebuild to be picked up.
