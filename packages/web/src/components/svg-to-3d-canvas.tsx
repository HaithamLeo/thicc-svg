 ...
 * =============================================================================
 *
 * Web editor wrapper around the thicc-svg engine's <SVG3D> component. Injects
...
import { SVG3D, materialPresets } from "thicc-svg";
import type { AnimationType, MaterialSettings } from "thicc-svg";
...
function buildExportGroup(scene: THREE.Scene, meshOnly = false): THREE.Group {
...
function Download3DCapture({
  ...
  useEffect(() => {
    ...
    register3DExport((format, filename = "thicc-svg", meshOnly = false) => {
      const group = buildExportGroup(scene, meshOnly);
