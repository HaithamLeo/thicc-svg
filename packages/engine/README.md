...
![thicc-svg](https://raw.githubusercontent.com/HaithamLeo/thicc-svg/main/.github/assets/demo.png)

The easiest way to turn SVGs into interactive React 3D components.

[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://github.com/HaithamLeo/thicc-svg/blob/main/LICENSE)
[![npm](https://img.shields.io/npm/v/thicc-svg)](https://www.npmjs.com/package/thicc-svg)
[![npm bundle size](https://img.shields.io/bundlephobia/minzip/thicc-svg)](https://bundlephobia.com/package/thicc-svg)
...
```tsx
const SVG3D = dynamic(
  () => import("thicc-svg").then((m) => ({ default: m.SVG3D })),
  { ssr: false },
);
```
...
Design 3D objects visually and export embed code at [thicc-svg.design](https://thicc-svg.design).
